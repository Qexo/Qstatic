...
function darkMode(el) {
  ...
  const modal_bg_gradient_dark = document.querySelectorAll('.modal-content.bg-gradient-dark');
  const modal_bg_white = document.querySelectorAll('.modal-content.bg-white');
  const form_bg_gradient_dark = document.querySelectorAll('.form-control.bg-gradient-dark');
  const form_bg_white = document.querySelectorAll('.form-control.bg-white');
  ...
  if (!el.getAttribute("checked")) {
    ...
    for(var i = 0; i < modal_bg_gradient_dark.length; i++) {
      if (modal_bg_gradient_dark[i].classList.contains('bg-gradient-dark')) {
        modal_bg_gradient_dark[i].classList.remove('bg-gradient-dark');
        modal_bg_gradient_dark[i].classList.add('bg-white');
      }
    }

    for(var i = 0; i < modal_bg_white.length; i++) {
      if (modal_bg_white[i].classList.contains('bg-white')) {
        modal_bg_white[i].classList.remove('bg-white');
        modal_bg_white[i].classList.add('bg-gradient-dark');
      }
    }

    for(var i = 0; i < form_bg_gradient_dark.length; i++) {
      if (form_bg_gradient_dark[i].classList.contains('bg-gradient-dark')) {
        form_bg_gradient_dark[i].classList.remove('bg-gradient-dark');
        form_bg_gradient_dark[i].classList.add('bg-white');
      }
    }

    for(var i = 0; i < form_bg_white.length; i++) {
      if (form_bg_white[i].classList.contains('bg-white')) {
        form_bg_white[i].classList.remove('bg-white');
        form_bg_white[i].classList.add('bg-gradient-dark');
      }
    }
...
function applyNight(isNight){
  if (isNight!==ifSysIsNight()){
    document.querySelector('#dark-version').click();
  }
}
if (isNight === null){
    isNight = ifSysIsNight();
    applyNight(isNight);
    localStorage.setItem('night', isNight);
}
else{
